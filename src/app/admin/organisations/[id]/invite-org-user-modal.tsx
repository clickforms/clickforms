...
/** Admin-scoped equivalent of src/app/forms/users/add-user-modal.tsx — invites a user
 * into an organisation the platform admin isn't themselves a member of. */
export function InviteOrgUserModal({
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      const res = await fetch(`/api/admin/organizations/${organizationId}/invites`, {
        method: 'POST',
    ...
    <div className="modal-overlay" onMouseDown={handleClose}>
      ...
      >
        <div className="modal-header">
          <h2 className="modal-title" id="invite-org-user-title">
            Invite a user
          </h2>
