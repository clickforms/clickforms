import type { FieldOption, FormField, FormSchema } from '../../src/lib/forms/schema';
...
/** Pre-built schema matching a typical A2A Incident Report Form structure. Seeded as a
 * published FormTemplate row by prisma/seed.ts — previously a hardcoded entry in the
 * app's own FORM_TEMPLATES registry (removed once the template library became
 * admin-managed data instead of compiled-in code; see FormTemplate in
 * prisma/schema.prisma). Kept under prisma/ since it's now seed data, not app code. */
